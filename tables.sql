...
dotnet ef dbcontext scaffold "Host=localhost;Port=5432;Database=truhome;Username=postgres;Password=Kaara;" Npgsql.EntityFrameworkCore.PostgreSQL -o Entities -c TruhomeDbContext --context-dir Contexts --force
